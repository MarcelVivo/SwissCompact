...
const checks = {
  ...
  directDisplayAssignment: ["Auf Bildschirm anzeigen", "CampaignPreset"].every((label) => portal.includes(label)) && displayManagement.includes("Inhalt zuweisen") && portal.includes("campaign ? initialStep : preset?.startStep || 1") && portal.includes("ensureCampaignDraft") && portal.includes("Ihre Auswahl wird automatisch als Entwurf gespeichert"),
