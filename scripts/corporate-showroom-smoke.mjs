...
const expectations = {
  corporateLobby: {
    roomSize: "small",
    floor: "stone",
    minimumFurnishings: 4,
    minimumDisplays: 3,
    selection: "furnishing:corporate-lobby-brand-wall",
    label: "Empfang & Lobby",
  },
  corporateMeeting: {
    roomSize: "small",
    ...
    minimumFurnishings: 4,
    minimumDisplays: 1,
    selection: "furnishing:corporate-meeting-table",
  ...
  corporateCanteen: {
    ...
    minimumDisplays: 6,
    selection: "furnishing:corporate-canteen-dining",
    label: "Mitarbeitendenrestaurant",
  },
};
...
try {
  ...
  await page.locator('[data-showroom-theme-option="corporate"]').click();
  await page.waitForFunction(() => (
    document.querySelector("[data-showroom]")?.getAttribute(
      "data-showroom-theme",
    ) === "corporate"
  ...
  for (const preset of presets) {
    ...
    await page.screenshot({
      path: `/tmp/swisscompact-corporate-${preset}.png`,
      fullPage: false,
    });
