...
const presets = ["fashionStore", "electronicsStore", "shoppingMall"];
const expectations = {
  fashionStore: {
    roomSize: "small",
    floor: "wood",
    minimumFurnishings: 15,
    selection: "furnishing:fashion-rack-women-1",
  },
  electronicsStore: {
    roomSize: "compact",
    floor: "stone",
    minimumFurnishings: 10,
    selection: "furnishing:tech-smartphone-table-1",
  },
  shoppingMall: {
    roomSize: "standard",
    floor: "stone",
    minimumFurnishings: 20,
    selection: "furnishing:mall-shop-left-1",
  },
};
...
try {
  ...
  await page.locator('[data-showroom-theme-option="retail"]').click();
  await page.waitForFunction(() => (
    document.querySelector("[data-showroom]")?.getAttribute(
      "data-showroom-theme",
    ) === "retail"
  ...
  for (const preset of presets) {
    ...
    await page.screenshot({
      path: `/tmp/swisscompact-retail-${preset}.png`,
      fullPage: false,
    });
