-- Repariert Installationen, bei denen die optionale Bildschirmkonfiguration
-- vor Phase 5 nicht ausgeführt oder vom PostgREST-Schema-Cache nicht erkannt wurde.
begin;
...
-- PostgREST übernimmt die neuen Spalten unmittelbar nach dem Commit.
