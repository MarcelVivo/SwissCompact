...
function DeleteDialog({ target, busy, error, onCancel, onConfirm }: { target: DeleteTarget; busy: boolean; error: string; onCancel: () => void; onConfirm: () => void }) {
  const labelsByKind = {
    content: { eyebrow: "Inhalt löschen", noun: "Inhalt", detail: "Der Inhalt wird dauerhaft entfernt und aus Entwürfen sowie pausierten Kampagnen gelöscht. Aktive oder geplante Kampagnen müssen zuerst angepasst werden." },
    campaign: { eyebrow: "Kampagne löschen", noun: "Kampagne", detail: "Die Kampagne sowie ihre Inhalts- und Display-Zuordnungen werden dauerhaft gelöscht. Laufende oder geplante Kampagnen müssen zuerst pausiert werden." },
