...
import { mountCardLinks } from "./ui/cardLinks";
...
const businessPlatformCardLinks = mountCardLinks(".business-platform__card", ".business-platform__card-link");
...
if (prefersReducedMotion) {
  ...
  try {
    ...
    window.addEventListener("pagehide", () => {
      ...
      businessPlatformCardLinks.destroy();
